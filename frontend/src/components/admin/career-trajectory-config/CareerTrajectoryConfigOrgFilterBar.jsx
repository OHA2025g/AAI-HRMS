...
export default function CareerTrajectoryConfigOrgFilterBar({ jobs = [] }) {
  ...
  return (
    <div className="ctw-topbar-filters" data-testid="career-traj-config-org-filter-bar">
      <select
        value={pillarId || ALL}
        onChange={(e) => {
        ...
        data-testid="career-traj-config-pillar-filter"
      >
      ...
      <select
        ...
        data-testid="career-traj-config-department-filter"
      >
      ...
      <select
        ...
        data-testid="career-traj-config-subdepartment-filter"
      >
      ...
      <select
        ...
        data-testid="career-traj-config-project-filter"
      >
      ...
      <button type="button" className="ctw-clear-btn" onClick={clearAll} data-testid="career-traj-config-clear-filters">
        Clear filters
      </button>
    </div>
  );
