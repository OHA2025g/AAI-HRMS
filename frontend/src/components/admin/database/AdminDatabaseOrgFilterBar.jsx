...
export default function AdminDatabaseOrgFilterBar({ jobs = [] }) {
  ...
  return (
    <div className="dbm-topbar-filters" data-testid="admin-database-org-filter-bar">
      <select
        value={pillarId || ALL}
        onChange={(e) => {
      ...
      <button type="button" className="dbm-clear-btn" onClick={clearAll}>
        Clear filters
      </button>
    </div>
  );
