...
export default function AdminIntegrationsOrgFilterBar({ jobs = [] }) {
  ...
  return (
    <div className="aic-topbar-filters" data-testid="admin-integrations-org-filter-bar">
      <select
        value={pillarId || ALL}
        onChange={(e) => {
      ...
      <button type="button" className="aic-clear-btn" onClick={clearAll}>
        Clear filters
      </button>
    </div>
  );
