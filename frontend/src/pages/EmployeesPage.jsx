...
import { employeeApi, trainingRecommendationsApi } from '../lib/api';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button className="bg-indigo-600 hover:bg-indigo-700"><Plus className="w-4 h-4 mr-2" />Add Employee</Button>
          </DialogTrigger>
          <DialogContent>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Select value={departmentFilter} onValueChange={setDepartmentFilter}>
          <SelectTrigger className="w-[190px]"><SelectValue placeholder="Department" /></SelectTrigger>
          <SelectContent>
