                  ...
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-slate-500">{app.candidate?.headline || app.candidate?.email}</p>
                      </div>
                    ...
                    {app.fit_score && (
                      <div className="flex items-center gap-3 mb-3">
                        <FitScoreRing score={app.fit_score.final_score} size={48} />
                        <div className="text-sm">
                          <p className="text-slate-600">Fit Score</p>
                          {app.fit_score.must_have_ok ? (
                            <span className="text-emerald-600 flex items-center gap-1">
                              <CheckCircle className="w-3 h-3" /> Has required skills
                            </span>
                          ) : (
                            <span className="text-red-600 flex items-center gap-1">
                              <XCircle className="w-3 h-3" /> Missing required
                            </span>
                          )}
                        </div>
                      </div>
                    ...
                    <Link to={`/candidates/${app.candidate?.id}`}>
