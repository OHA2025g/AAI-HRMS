...
const InterviewsPage = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <motion.div variants={itemVariants} className="flex flex-col lg:flex-row lg:items-center lg:flex-nowrap justify-between gap-3">
        ...
        <Dialog open={showModal} onOpenChange={setShowModal}>
          <DialogTrigger asChild>
            <Button className="w-full lg:w-auto bg-indigo-600 hover:bg-indigo-700" data-testid="schedule-interview-btn">
