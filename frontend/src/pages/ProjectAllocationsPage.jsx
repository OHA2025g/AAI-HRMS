    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-slate-600">Assign allocated capacity per project + skill to drive supply-side analytics.</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Select a project to define allocated supply per skill.</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{rowsLoading ? 'Loading...' : 'Upsert allocated_count per skill.'}</CardDescription>
        </CardHeader>
        <CardContent>
          {projects.length === 0 ? (
