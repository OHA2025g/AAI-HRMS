...
import { employeeLifecycleApi, automationApi, adminApi } from '../lib/api';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-slate-900" style={{ fontFamily: 'Outfit' }}>Employee Lifecycle</h1>
